...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> STEELSTALB = registerBlock("steel_slab",
    ...
    public static final RegistryObject<Block> STEELDOOR = registerBlock("steel_door",
            () -> new DoorBlock(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).strength(6.0f,7.0f), BlockSetType.IRON));
    public static final RegistryObject<Block> STEELTRAPDOOR = registerBlock("steel_trap_door",
            () -> new TrapDoorBlock(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).strength(6.0f,7.0f), BlockSetType.IRON));
